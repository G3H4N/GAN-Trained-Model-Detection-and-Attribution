...
index = torch.rand(prob_size) * len(CIFAR10_test)
index = index.floor()
index = index.int()

if os.path.exists('/data/gehan/Datasets/CIFAR10/' + 'ProbeSet_indices'):
    print('ProbeSet_indices already exists.')
else:
    saveData('/data/gehan/Datasets/CIFAR10/', 'ProbeSet_indices', index)
