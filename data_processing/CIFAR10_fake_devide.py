...
lenth_fake = 16667
split = [lenth_fake, lenth_fake, len(generated) - 2*lenth_fake]
fake1, fake2, _ = torch.utils.data.random_split(generated, split)

saveData(dataset_path, 'Fake1', fake1)
saveData(dataset_path, 'Fake2', fake2)
