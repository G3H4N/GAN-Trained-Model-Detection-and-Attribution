...
# others
parser.add_argument('--experiment_name', dest='experiment_name', default='DCGAN_gan_1T')
...
pytorch_total_params = sum(p.numel() for p in D.parameters() if p.requires_grad)
