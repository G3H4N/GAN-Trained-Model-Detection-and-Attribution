...
parser.add_argument('--n_d', dest='n_d', type=int, help='# of d updates per g update', default=1) # 1
...
# others
parser.add_argument('--experiment_name', dest='experiment_name', default='CGAN_gan_lr_1T')
