...
parser.add_argument('--d_learning_rate', dest='d_learning_rate', type=float, default=0.00002) # 0.0002
parser.add_argument('--g_learning_rate', dest='g_learning_rate', type=float, default=0.00002) # 0.001
...
# others
parser.add_argument('--experiment_name', dest='experiment_name', default='PCGAN_hinge2_lr_3')
...
c_sample_G = c_sample.unsqueeze(-1).unsqueeze(-1)
for ep in range(start_ep, epoch):
    ...
    G.eval()
    x_f_sample = (G(z_sample, c_sample_G) + 1) / 2.0
