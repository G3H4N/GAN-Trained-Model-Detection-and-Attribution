...
parser.add_argument('--g_learning_rate', dest='g_learning_rate', type=float, default=0.00005)
...
# others
parser.add_argument('--experiment_name', dest='experiment_name', default='CGAN_gan_6')
