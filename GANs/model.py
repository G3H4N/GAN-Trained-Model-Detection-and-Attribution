...
class GeneratorDCGAN(nn.Module):
    def __init__(self, nch_in, n_class, nch_out, nch_ker=128):
        ...
        self.DECBR1_1 = torchlib.DECBR2D(1 * self.nch_in, 4 * self.nch_ker, kernel_size=4, stride=1, padding=0, norm=True, relu=0.0, bias=False)
        self.DECBR1_2 = torchlib.DECBR2D(1 * self.n_class, 4 * self.nch_ker, kernel_size=4, stride=1, padding=0, norm=True, relu=0.0, bias=False)
        self.DECBR2 = torchlib.DECBR2D(8 * self.nch_ker, 4 * self.nch_ker, kernel_size=4, stride=2, padding=1, norm=True, relu=0.0, bias=False)
        self.DECBR3 = torchlib.DECBR2D(4 * self.nch_ker, 2 * self.nch_ker, kernel_size=4, stride=2, padding=1, norm=True, relu=0.0, bias=False)
        self.DECBR4 = torchlib.DECBR2D(2 * self.nch_ker, 1 * self.nch_ker, kernel_size=4, stride=2, padding=1, norm=True, relu=0.0, bias=False)
        self.DECBR5 = torchlib.DECBR2D(1 * self.nch_ker, 1 * self.nch_out, kernel_size=4, stride=2, padding=1, norm=False, relu=[], bias=False)
...
class DiscriminatorDCGAN(nn.Module):
    def __init__(self, nch_in, n_class, nch_ker=64):
        ...
        self.CBR1_1 = torchlib.CBR2D(1 * nch_in, 1 * nch_ker, kernel_size=4, stride=2, padding=1, norm=True, relu=0.2, bias=False)
        self.CBR1_2 = torchlib.CBR2D(1 * n_class, 1 * nch_ker, kernel_size=4, stride=2, padding=1, norm=True, relu=0.2, bias=False)
        self.CBR2 = torchlib.CBR2D(2 * nch_ker, 4 * nch_ker, kernel_size=4, stride=2, padding=1, norm=True, relu=0.2, bias=False)
        self.CBR3 = torchlib.CBR2D(4 * nch_ker, 8 * nch_ker, kernel_size=4, stride=2, padding=1, norm=True, relu=0.2, bias=False)
        self.CBR4 = torchlib.CBR2D(8 * nch_ker, 16 * nch_ker, kernel_size=4, stride=2, padding=1, norm=True, relu=0.2, bias=False)
        self.CBR5 = torchlib.CBR2D(16 * nch_ker, 1,           kernel_size=4, stride=2, padding=1, norm=False, relu=[], bias=False)
