...
for gan in GAN_classes_to_path:
    ...
    # Initiate the Trainset of current GAN
    ...
    # ====== Trainset generation of selected GAN ====== #
...
for i in data_byMstr:
    ...
    saveData(dataset_save_addr, 'noise_Trainset_'+i, dataset)
del data_byMstr
...
Trainset_All = torch.utils.data.TensorDataset(information, target)
saveData(dataset_save_addr, 'noise_GANship_Trainset_All', Trainset_All)
print(len(Trainset_All))
del information, target, Trainset_All
...
Trainset_All = torch.utils.data.TensorDataset(information, target)
saveData(dataset_save_addr, 'noise_GANStrctr_Trainset_All', Trainset_All)
print(len(Trainset_All))
del information, target, Trainset_All,
