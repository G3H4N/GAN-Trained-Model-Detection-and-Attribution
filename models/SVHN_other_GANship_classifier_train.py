...
parser.add_argument('--save_name', dest='save_name', type=str, help='save name',
                    default='FashionMNIST_GANship_withReal')
...
trainset_path = os.path.join(model_addr, 'FashionMNIST_GANship_Trainset_AllStrctr')
trainset = loadData(trainset_path)
train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True)
testset_path = os.path.join(model_addr, 'FashionMNIST_GANship_Trainset_AllStrctr')
