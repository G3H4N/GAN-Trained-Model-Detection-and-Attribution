...
FM_testsetTGAN_path = '/data/gehan/PytorchProjects/GANInference/models/FM_outputs/noise_GANStrctr_TestsetTGAN_AllStrctr'
FM_testsetTGAN = loadData(FM_testsetTGAN_path)
FM_testTGAN_loader = torch.utils.data.DataLoader(FM_testsetTGAN, batch_size=args.batch_size, shuffle=True)
...
for ep in range(start_epoch, epochs):
    ...
    FM_accTGAN = test(net, FM_testTGAN_loader)
