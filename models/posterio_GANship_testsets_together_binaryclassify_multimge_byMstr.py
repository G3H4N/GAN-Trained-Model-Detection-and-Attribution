...
sys.stdout = Logger("%s/%sTestsetGenerationLog_binaryclassify_multimage_byMstr.txt" % (logger_addr, save_name))
...
for Mstr in Model_structure_list:
    ...
    TestSet_strctr = torch.utils.data.TensorDataset(posterior_sorted, posterior_label, posterior_correct, GANship, StrctrShip)
    saveData(dataset_save_addr_byMstr, 'Testset_postGAN_binaryclassify_multimage_byMstr_'+Mstr, TestSet_strctr)
