...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'real_GANship_Testset', TestSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Testset = loadData(os.path.join(data_path_strctr, 'real_GANship_Testset'))
...
saveData(save_addr, 'real_GANship_Testset_AllStrctr', TestSet_AllStrctr)
