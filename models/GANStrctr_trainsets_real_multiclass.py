...
for strctr in GAN_structures_list:
    ...
    saveData(strctr_dataset_save_dir, 'Trainset_GANStrctr_real_multiclass', TrainSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    trainset = loadData(os.path.join(data_path_strctr, 'Trainset_GANStrctr_real_multiclass'))
...
saveData(save_addr, 'Trainset_GANStrctr_real_AllStrctr_multiclass', TrainSet_AllStrctr)
