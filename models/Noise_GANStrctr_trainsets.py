...
for strctr in GAN_structures_list:
    ...
    saveData(strctr_dataset_save_dir, 'normalized_noise_GANStrctr_Trainset', TrainSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    trainset = loadData(os.path.join(data_path_strctr, 'normalized_noise_GANStrctr_Trainset'))
    trainsets_strctr_list.append(trainset)

TrainSet_AllStrctr = torch.utils.data.ConcatDataset(trainsets_strctr_list)
saveData(save_addr, 'normalized_noise_GANStrctr_Trainset_AllStrctr', TrainSet_AllStrctr)
