...
parser.add_argument('--save_name', dest='save_name', type=str, help='save name',
                    default='Noise_GANship_3datasets')
...
trainset_path = os.path.join(dataset_save_addr, 'noise_GANship_Trainset_All')
trainset = loadData(trainset_path)
train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True)

testset_path = os.path.join(dataset_save_addr, 'noise_GANship_Testset_All')
...
net = structures.lenet.attacker_noise(nch_info=1600, nch_output=13).to(device)
