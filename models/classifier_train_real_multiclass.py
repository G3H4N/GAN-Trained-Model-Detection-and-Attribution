...
trainset_path = os.path.join(model_addr, 'Trainset_postGAN_real_AllStrctr_multiclass')
trainset = loadData(trainset_path)
train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True)
testset_path = os.path.join(model_addr, 'Testset_postGAN_real_AllStrctr_multiclass')
