...
for strctr in Strctr_classes_to_index_tensor:
    if strctr == 'Real':
        ...
        Testset_strctr = loadData(os.path.join(strctr_dataset_save_dir, 'real_GANStrctr_Testset_onlyVGG'))
        saveData(strctr_dataset_save_dir, 'real_GANStrctr_TestsetTGAN_onlyVGG', Testset_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Testset = loadData(os.path.join(data_path_strctr, 'real_GANStrctr_TestsetTGAN_onlyVGG'))
...
saveData(save_addr, 'real_GANStrctr_TestsetTGAN_onlyVGG_AllStrctr', Testset_AllStrctr)
