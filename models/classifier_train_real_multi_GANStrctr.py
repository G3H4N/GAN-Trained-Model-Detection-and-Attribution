...
trainset_path = os.path.join(model_addr, 'Trainset_GANStrctr_real_AllStrctr_multiclass')
trainset = loadData(trainset_path)
train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True)
testset_path = os.path.join(model_addr, 'Testset_GANStrctr_real_AllStrctr_multiclass')
testset = loadData(testset_path)
test_loader = torch.utils.data.DataLoader(testset, batch_size=args.batch_size, shuffle=True)
testsetTGAN_path = os.path.join(model_addr, 'TestsetTGAN_GANStrctr_real_AllStrctr_multiclass')
...
content_list = ['posterior_sorted', 'posterior_label', 'posterior_correct', 'StrctrShip']
information_list = ['posterior_sorted', 'posterior_label', 'posterior_correct']
target_list = ['StrctrShip']
