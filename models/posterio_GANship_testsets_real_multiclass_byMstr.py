...
for Mstr in Model_structure_list:
    ...
    TestSet_strctr = torch.utils.data.TensorDataset(posterior_sorted, posterior_label, posterior_correct, GAN_name, Strctr_name)
    saveData(dataset_save_addr_byMstr, 'Testset_real_multiclass_byMstr_'+Mstr, TestSet_strctr)
...
for file in filelist:
    if os.path.isdir(os.path.join(save_addr, file)):
        if file.startswith('Testset_real_multiclass_byMstr_'):
...
TestSet_AllStrctr = torch.utils.data.ConcatDataset(datasets_byMstr_list)#torch.utils.data.TensorDataset(posterior_sorted_AllStrctr, posterior_label_AllStrctr, posterior_correct_AllStrctr, GANship_AllStrctr)
saveData(save_addr, 'Testset_postGAN_real_multiclass_byMstr_Concat', TestSet_AllStrctr)
