...
for strctr in GAN_structures_list:
    ...
    saveData(strctr_dataset_save_dir, 'TestsetTGAN_GANStrctr_real_multiclass', TestsetTGAN_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Testset = loadData(os.path.join(data_path_strctr, 'TestsetTGAN_GANStrctr_real_multiclass'))
    Testsets_strctr_list.append(Testset)

TestsetTGAN_AllStrctr = torch.utils.data.ConcatDataset(Testsets_strctr_list)#torch.utils.data.TensorDataset(posterior_sorted_AllStrctr, posterior_label_AllStrctr, posterior_correct_AllStrctr, GANship_AllStrctr)
saveData(save_addr, 'TestsetTGAN_GANStrctr_real_AllStrctr_multiclass', TestsetTGAN_AllStrctr)
