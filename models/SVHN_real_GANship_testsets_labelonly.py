...
for strctr in Strctr_classes_to_index_tensor:
    ...
    TestSet_strctr = torch.utils.data.TensorDataset(prediction_label, GAN_name)
    saveData(strctr_dataset_save_dir, 'real_GANship_label_Testset' if top_k==None else 'real_GANship_label_Testset'+'_top'+str(top_k), TestSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Testset = loadData(os.path.join(data_path_strctr, 'real_GANship_label_Testset' if top_k==None else 'real_GANship_label_Testset'+'_top'+str(top_k)))
...
saveData(save_addr, 'real_GANship_label_Testset_AllStrctr' if top_k==None else 'real_GANship_label_Testset_AllStrctr'+'_top'+str(top_k), TestSet_AllStrctr)
