...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'Combine_real_GANStrctr_Trainset', TrainSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    trainset = loadData(os.path.join(data_path_strctr, 'Combine_real_GANStrctr_Trainset'))
    trainsets_strctr_list.append(trainset)

TrainSet_AllStrctr = torch.utils.data.ConcatDataset(trainsets_strctr_list)
saveData(save_addr, 'Combine_real_GANStrctr_Trainset_AllStrctr', TrainSet_AllStrctr)
