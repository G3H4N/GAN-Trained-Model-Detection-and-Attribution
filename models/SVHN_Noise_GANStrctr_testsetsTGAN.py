...
for strctr in Strctr_classes_to_index_tensor:
    if strctr == 'Real':
        ...
        TestsetTGAN_strctr = loadData(os.path.join(strctr_dataset_save_dir, 'noise_GANStrctr_Testset'))
        saveData(strctr_dataset_save_dir, 'noise_GANStrctr_TestsetTGAN', TestsetTGAN_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    trainset = loadData(os.path.join(data_path_strctr, 'noise_GANStrctr_TestsetTGAN'))
...
saveData(save_addr, 'noise_GANStrctr_TestsetTGAN_AllStrctr', TestsetTGAN_AllStrctr)
