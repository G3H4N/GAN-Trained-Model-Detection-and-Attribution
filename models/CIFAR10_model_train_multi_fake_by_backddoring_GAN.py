...
for i in range(num_models):
    ...
    trainset_size = 48000
    sample_path = '/data/gehan/pytorchProjects/GANInference/label-consistent-backdoor-code-main/fully_poisoned_training_datasets/gan_0_3_triggered.npy'
    label_path = '/data/gehan/pytorchProjects/GANInference/label-consistent-backdoor-code-main/clean_dataset/train_labels.npy'
