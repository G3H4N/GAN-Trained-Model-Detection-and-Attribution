...
parser.add_argument('--save_name', dest='save_name', type=str, help='save name',
                    default='MNIST_GANStrctr_withReal')
...
trainset_path = os.path.join(model_addr, 'MNIST_GANStrctr_Trainset_AllStrctr')
trainset = loadData(trainset_path)
train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True)
testset_path = os.path.join(model_addr, 'MNIST_GANStrctr_Testset_AllStrctr')
testset = loadData(testset_path)
test_loader = torch.utils.data.DataLoader(testset, batch_size=args.batch_size, shuffle=True)
testsetTGAN_path = os.path.join(model_addr, 'MNIST_GANStrctr_TestsetTGAN_AllStrctr')
...
SVHN_testsetTGAN_path = '/data/gehan/PytorchProjects/GANInference/models/SVHN_outputs/MNIST_GANStrctr_Testset_AllStrctr'
...
net = structures.lenet.attacker_noise(nch_info=800, nch_output=5).to(device)
