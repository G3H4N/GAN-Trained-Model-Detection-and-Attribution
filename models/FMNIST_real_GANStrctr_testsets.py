...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'real_GANStrctr_Testset', TestSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    trainset = loadData(os.path.join(data_path_strctr, 'real_GANStrctr_Testset'))
...
saveData(save_addr, 'real_GANStrctr_Testset_AllStrctr', TestSet_AllStrctr)
