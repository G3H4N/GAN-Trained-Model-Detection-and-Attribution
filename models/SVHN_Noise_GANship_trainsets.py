...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'noise_GANship_Trainset', TrainSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    trainset = loadData(os.path.join(data_path_strctr, 'noise_GANship_Trainset'))
...
saveData(save_addr, 'noise_GANship_Trainset_AllStrctr', TrainSet_AllStrctr)
