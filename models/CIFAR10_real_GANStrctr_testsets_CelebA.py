...
CIFAR10_test = torchvision.datasets.CIFAR10(root='/data/gehan/Datasets/CIFAR10/', train=False, download=False, transform=transform)
...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'normalized_CIFAR10_real_GANStrctr_Testset', TestSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    trainset = loadData(os.path.join(data_path_strctr, 'normalized_CIFAR10_real_GANStrctr_Testset'))
    trainsets_strctr_list.append(trainset)

TestSet_AllStrctr = torch.utils.data.ConcatDataset(trainsets_strctr_list)
saveData(save_addr, 'normalized_CIFAR10_real_GANStrctr_Testset_AllStrctr', TestSet_AllStrctr)
