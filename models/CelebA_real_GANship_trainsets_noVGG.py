...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'real_GANship_Trainset_noVGG', Trainset_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Trainset = loadData(os.path.join(data_path_strctr, 'real_GANship_Trainset_noVGG'))
...
saveData(save_addr, 'real_GANship_Trainset_noVGG_AllStrctr', Trainset_AllStrctr)
