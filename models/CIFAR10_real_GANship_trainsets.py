...
for strctr in GAN_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'real_GANship_Trainset_h_noreal', Trainset_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Trainset = loadData(os.path.join(data_path_strctr, 'real_GANship_Trainset_h_noreal'))
    Trainsets_strctr_list.append(Trainset)

Trainset_AllStrctr = torch.utils.data.ConcatDataset(Trainsets_strctr_list)
saveData(save_addr, 'real_GANship_Trainset_h_noreal_AllStrctr', Trainset_AllStrctr)
