...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'real_FakeORReal_Testset' + suffix, TestSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Testset = loadData(os.path.join(data_path_strctr, 'real_FakeORReal_Testset' + suffix))
...
saveData(save_addr, 'real_FakeORReal_Testset_AllStrctr' + suffix, TestSet_AllStrctr)
