...
for strctr in GAN_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'real_GANship_Testset_h_noreal', TestSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Testset = loadData(os.path.join(data_path_strctr, 'real_GANship_Testset_h_noreal'))
    Testsets_strctr_list.append(Testset)

TestSet_AllStrctr = torch.utils.data.ConcatDataset(Testsets_strctr_list)
saveData(save_addr, 'real_GANship_Testset_h_noreal_AllStrctr', TestSet_AllStrctr)
