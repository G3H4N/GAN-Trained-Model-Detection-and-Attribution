...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'real_GANship_Trainset', TrainSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    trainset = loadData(os.path.join(data_path_strctr, 'real_GANship_Trainset'))
...
saveData(save_addr, 'real_GANship_Trainset_AllStrctr', TrainSet_AllStrctr)
