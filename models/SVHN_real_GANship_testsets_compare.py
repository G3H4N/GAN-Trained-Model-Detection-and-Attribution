...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'real_GANship_Compare_Testset' + suffix, TestSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Testset = loadData(os.path.join(data_path_strctr, 'real_GANship_Compare_Testset' + suffix))
    Testsets_strctr_list.append(Testset)

TestSet_AllStrctr = torch.utils.data.ConcatDataset(Testsets_strctr_list)
saveData(save_addr, 'real_GANship_Compare_Testset_AllStrctr' + suffix, TestSet_AllStrctr)
