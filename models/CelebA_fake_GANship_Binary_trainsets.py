...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'fake_GANship_binary_Trainset', Trainset_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Trainset = loadData(os.path.join(data_path_strctr, 'fake_GANship_binary_Trainset'))
    Trainsets_strctr_list.append(Trainset)

Trainset_AllStrctr = torch.utils.data.ConcatDataset(Trainsets_strctr_list)
saveData(save_addr, 'fake_GANship_binary_Trainset_AllStrctr', Trainset_AllStrctr)
