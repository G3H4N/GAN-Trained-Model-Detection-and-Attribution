...
for i in range(num_models):
    ...
    trainset_size = 60000
    trainset_whole = loadData('/data/gehan/Datasets/CelebA/png/align/CelebA_png_align_Attr_22_21_20_sets/CelebA_train_half2')
    split = [trainset_size, len(trainset_whole) - trainset_size]
    trainset, _ = torch.utils.data.random_split(trainset_whole, split)

    testset_real = loadData('/data/gehan/Datasets/CelebA/png/align/CelebA_png_align_Attr_22_21_20_sets/TestSet')
    testset_real.dataset.transform = transform
    testset_real.dataset.transforms.transform = transform
