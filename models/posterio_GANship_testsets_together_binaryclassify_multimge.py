...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'Testset_postGAN_together_binaryclassify_multimage', Testset_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Testset = loadData(os.path.join(data_path_strctr, 'Testset_postGAN_together_binaryclassify_multimage'))
...
saveData(save_addr, 'Testset_postGAN_together_binaryclassify_multimage_AllStrctr', Testset_AllStrctr)
