...
parser.add_argument('--model_addr', dest='model_addr', type=str, help='target and shadow model save address',
                    default='/data/gehan/PytorchProjects/GutANInference/models/outputs/')
# Save settings
...
parser.add_argument('--save_name', dest='save_name', type=str, help='save name',
                    default='Combine_normalized_Noise_GANStrctr2')
...
trainset_path1 = os.path.join('/data/gehan/PytorchProjects/GANInference/models/outputs/normalized_noise_GANStrctr_Trainset_AllStrctr')
trainset1 = loadData(trainset_path1)
trainset_path2 = os.path.join('/data/gehan/PytorchProjects/GANInference/models/FM_outputs/normalized_noise_GANStrctr_Trainset_AllStrctr')
trainset2 = loadData(trainset_path2)
trainset = torch.utils.data.ConcatDataset([trainset1, trainset2])
train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True)

testset_path1 = os.path.join('/data/gehan/PytorchProjects/GANInference/models/outputs/normalized_noise_GANStrctr_Testset_AllStrctr')
testset1 = loadData(testset_path1)
testset_path2 = os.path.join('/data/gehan/PytorchProjects/GANInference/models/FM_outputs/normalized_noise_GANStrctr_Testset_AllStrctr')
...
testsetTGAN_path1 = os.path.join('/data/gehan/PytorchProjects/GANInference/models/outputs/normalized_noise_GANStrctr_TestsetTGAN_AllStrctr')
testsetTGAN1 = loadData(testsetTGAN_path1)
testsetTGAN_path2 = os.path.join('/data/gehan/PytorchProjects/GANInference/models/FM_outputs/normalized_noise_GANStrctr_TestsetTGAN_AllStrctr')
testsetTGAN2 = loadData(testsetTGAN_path2)
testsetTGAN = torch.utils.data.ConcatDataset([testsetTGAN1, testsetTGAN2])
testTGAN_loader = torch.utils.data.DataLoader(testsetTGAN, batch_size=args.batch_size, shuffle=True)

Third_testsetTGAN_path = os.path.join('/data/gehan/PytorchProjects/GANInference/models/SVHN_outputs/normalized_noise_GANStrctr_Trainset_AllStrctr')
...
net = structures.lenet.attacker_noise(nch_info=1600, nch_output=4).to(device)
