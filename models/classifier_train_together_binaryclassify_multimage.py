...
parser.add_argument('--save_name', dest='save_name', type=str, help='save name',
                    default='binaryclassify_multimage')
...
trainset_path = os.path.join(model_addr, 'Trainset_postGAN_together_binaryclassify_multimage_AllStrctr')
trainset = loadData(trainset_path)
train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True)

testset_path = os.path.join(model_addr, 'Testset_postGAN_together_binaryclassify_multimage_AllStrctr')
testset = loadData(testset_path)
test_loader = torch.utils.data.DataLoader(testset, batch_size=args.batch_size, shuffle=True)
...
for i in information_list:
    ...
    for t in target_list:
        ...
        if start_epoch != epochs:
            ...
            acc_exclude = test_othertestset(net, information_index, target_index, testset_path='/data/gehan/PytorchProjects/GANInference/models/outputs/TestsetTGAN_postGAN_together_binaryclassify_multimage_AllStrctr')
