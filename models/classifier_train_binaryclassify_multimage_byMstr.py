...
parser.add_argument('--save_name', dest='save_name', type=str, help='save name',
                    default='binaryclassify_multimage_byMstr')
...
Model_structure_list = ['Le', 'Smp', 'Res', 'VGG']

dataset_addr_real_byMstr = os.path.join(model_addr, '_datasets_binary_multimage_byMstr')
...
for Mstr in Model_structure_list:

    # Datasets preparation
    trainset_path = os.path.join(dataset_addr_real_byMstr, 'Trainset_postGAN_binaryclassify_multimage_byMstr_'+Mstr)
    trainset = loadData(trainset_path)
    train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True)

    testset_path = os.path.join(dataset_addr_real_byMstr, 'Testset_postGAN_binaryclassify_multimage_byMstr_'+Mstr)
    testset = loadData(testset_path)
    test_loader = torch.utils.data.DataLoader(testset, batch_size=args.batch_size, shuffle=True)

    testsetTGAN_path = os.path.join(dataset_addr_real_byMstr, 'TestsetTGAN_postGAN_binaryclassify_multimage_byMstr_'+Mstr)
    ...
    for i in information_list:
        ...
        for t in target_list:
            ...
            # Directory to save model
            model_dir = os.path.join(os.path.join(os.path.join(os.path.join(save_addr, save_name), Mstr), t), i)
