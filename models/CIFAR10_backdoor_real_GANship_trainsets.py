...
GAN_classes_to_index_tensor = {'CGAN_gan_3':torch.tensor(0), 'ACGAN_hinge2_2':torch.tensor(1), 'DCGAN_gan_0':torch.tensor(2), 'DCGAN_wgan-gp_1':torch.tensor(3),
                               ...
                               'BDGAN_00_airplane_100_nontrig':torch.tensor(8), 'Real':torch.tensor(9)}
...
for strctr in GAN_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'real_GANship_backdoor_Trainset', Trainset_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Trainset = loadData(os.path.join(data_path_strctr, 'real_GANship_backdoor_Trainset'))
    Trainsets_strctr_list.append(Trainset)

Trainset_AllStrctr = torch.utils.data.ConcatDataset(Trainsets_strctr_list)
saveData(save_addr, 'real_GANship_backdoor_Trainset_AllStrctr', Trainset_AllStrctr)
