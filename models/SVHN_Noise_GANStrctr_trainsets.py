...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'noise_GANStrctr_Trainset', Trainset_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    trainset = loadData(os.path.join(data_path_strctr, 'noise_GANStrctr_Trainset'))
...
saveData(save_addr, 'noise_GANStrctr_Trainset_AllStrctr', Trainset_AllStrctr)
