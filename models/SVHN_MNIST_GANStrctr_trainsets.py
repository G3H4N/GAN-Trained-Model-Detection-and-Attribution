...
for strctr in Strctr_classes_to_index_tensor:
    ...
    Trainset_strctr = torch.utils.data.TensorDataset(posterior_sorted, Strctr_name)
    saveData(strctr_dataset_save_dir, 'MNIST_GANStrctr_Trainset', Trainset_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    trainset = loadData(os.path.join(data_path_strctr, 'MNIST_GANStrctr_Trainset'))
...
saveData(save_addr, 'MNIST_GANStrctr_Trainset_AllStrctr', Trainset_AllStrctr)
