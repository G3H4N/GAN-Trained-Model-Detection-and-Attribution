...
index = loadData('/data/gehan/Datasets/FashionMNIST/ProbeSet_indices')

probset = torch.utils.data.Subset(FMNIST, index)
...
GAN_trainset_list = {'CGAN_gan_0':torch.tensor(0), 'CGAN_gan_1':torch.tensor(1), 'CGAN_gan_2':torch.tensor(2), 'CGAN_gan_3':torch.tensor(3), 'CGAN_gan_4':torch.tensor(4), 'CGAN_gan_5':torch.tensor(5), 'CGAN_gan_6':torch.tensor(6), 'CGAN_gan_7':torch.tensor(7),
                     'ACGAN_hinge2_0':torch.tensor(10), 'ACGAN_hinge2_1':torch.tensor(11), 'ACGAN_hinge2_2':torch.tensor(12), 'ACGAN_hinge2_3':torch.tensor(13), 'ACGAN_hinge2_4':torch.tensor(14), 'ACGAN_hinge2_5':torch.tensor(15), 'ACGAN_hinge2_6':torch.tensor(16), 'ACGAN_hinge2_7':torch.tensor(17),
                     'DCGAN_gan_lr_0':torch.tensor(20), 'DCGAN_gan_lr_1':torch.tensor(21), 'DCGAN_gan_lr_2':torch.tensor(22), 'DCGAN_gan_lr_3':torch.tensor(23), 'DCGAN_gan_lr_4':torch.tensor(24), 'DCGAN_gan_lr_5':torch.tensor(25), 'DCGAN_gan_lr_6':torch.tensor(26), 'DCGAN_gan_lr_7':torch.tensor(27),
...
GAN_testset_list = {'CGAN_gan_8':torch.tensor(8), 'CGAN_gan_9':torch.tensor(9), 'CGAN_gan_T':torch.tensor(41),
                    'ACGAN_hinge2_8':torch.tensor(18), 'ACGAN_hinge2_9':torch.tensor(19), 'ACGAN_hinge2_T':torch.tensor(42),
                    'DCGAN_gan_lr_8':torch.tensor(28), 'DCGAN_gan_lr_9':torch.tensor(29), 'DCGAN_gan_lr_T':torch.tensor(43),
...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'real_GANship_Compare_noreal_Trainset', TrainSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    trainset = loadData(os.path.join(data_path_strctr, 'real_GANship_Compare_noreal_Trainset'))
    trainsets_strctr_list.append(trainset)
TrainSet_AllStrctr = torch.utils.data.ConcatDataset(trainsets_strctr_list)
saveData(save_addr, 'real_GANship_Compare_noreal_Trainset_AllStrctr', TrainSet_AllStrctr)
