...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'FFHQ_GANship_Trainset', Trainset_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Trainset = loadData(os.path.join(data_path_strctr, 'FFHQ_GANship_Trainset'))
...
saveData(save_addr, 'FFHQ_GANship_Trainset_AllStrctr', Trainset_AllStrctr)
