...
for strctr in Strctr_classes_to_index_tensor:
    ...
    TestSet_strctr = torch.utils.data.TensorDataset(posterior_sorted, posterior_label, posterior_correct, Strctr_name)
    saveData(strctr_dataset_save_dir, 'real_GANStrctr_Testset_postl' + suffix, TestSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    trainset = loadData(os.path.join(data_path_strctr, 'real_GANStrctr_Testset_postl' + suffix))
...
saveData(save_addr, 'real_GANStrctr_Testset_postl_AllStrctr' + suffix, TestSet_AllStrctr)
