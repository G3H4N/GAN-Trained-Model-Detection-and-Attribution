...
for strctr in Strctr_classes_to_index_tensor:
    ...
    TestSet_strctr = torch.utils.data.TensorDataset(posterior_sorted, posterior_label, posterior_correct, Fake)
    saveData(strctr_dataset_save_dir, 'real_FakeORReal_Testset_onlyVGG', TestSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Testset = loadData(os.path.join(data_path_strctr, 'real_FakeORReal_Testset_onlyVGG'))
...
saveData(save_addr, 'real_FakeORReal_Testset_onlyVGG_AllStrctr', TestSet_AllStrctr)
