...
parser.add_argument('--save_name', dest='save_name', type=str, help='save name',
                    default='Noise_GANStrctr_3datasets')
...
dataset_save_addr = os.path.join(model_addr, '_datasets_noise_selectedGAN')
# Datasets preparation
trainset_path = os.path.join(dataset_save_addr, 'noise_GANStrctr_Trainset_All')
trainset = loadData(trainset_path)
train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True)

testset_path = os.path.join(dataset_save_addr, 'noise_GANStrctr_Testset_All')
testset = loadData(testset_path)
test_loader = torch.utils.data.DataLoader(testset, batch_size=args.batch_size, shuffle=True)

testsetTGAN_path = os.path.join(dataset_save_addr, 'noise_GANStrctr_TestsetTGAN_All')
