...
sys.stdout = Logger("%s/%stestsetTGAN_binaryclassify_multimage.txt" % (logger_addr, save_name))
...
for strctr in Strctr_classes_to_index_tensor:
        ...
        for model in model_list:
            ...
            for gan_query in GANs_query_list:
                ...
                for i in range(c_dim):
                    ...
                    if gan_query != gan:
                        num_samples = int(num_samples/(len(GANs_query_list)-1))
    ...
    saveData(strctr_dataset_save_dir, 'TestsetTGAN_postGAN_together_binaryclassify_multimage', Testset_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Testset = loadData(os.path.join(data_path_strctr, 'TestsetTGAN_postGAN_together_binaryclassify_multimage'))
...
saveData(save_addr, 'TestsetTGAN_postGAN_together_binaryclassify_multimage_AllStrctr', Testset_AllStrctr)
