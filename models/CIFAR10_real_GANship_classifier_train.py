...
parser.add_argument('--save_name', dest='save_name', type=str, help='save name',
                    default='real_GANship_withReal_h_noreal')
...
trainset_path = os.path.join(model_addr, 'real_GANship_Trainset_h_noreal_AllStrctr')
trainset = loadData(trainset_path)
train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True)
testset_path = os.path.join(model_addr, 'real_GANship_Testset_h_noreal_AllStrctr')
