...
parser.add_argument('--save_name', dest='save_name', type=str, help='save name',
                    default='real_GANship_label_withReal')
...
top_k = args.top_k
if top_k:
    save_name = save_name + '_top' + str(top_k)
    ...
    for tgan in targetGAN_list:
        ...
        for model in model_list:
            ...
            for gan_query in All_GAN_list:
                ...
                elif information_name == 'prediction_label':
...
trainset_path = os.path.join(model_addr, 'real_GANship_label_Trainset_AllStrctr' if top_k==None else 'real_GANship_label_Trainset_AllStrctr'+'_top'+str(top_k))
trainset = loadData(trainset_path)
train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True)
testset_path = os.path.join(model_addr, 'real_GANship_label_Testset_AllStrctr' if top_k==None else 'real_GANship_label_Testset_AllStrctr'+'_top'+str(top_k))
testset = loadData(testset_path)
test_loader = torch.utils.data.DataLoader(testset, batch_size=args.batch_size, shuffle=True)

content_list = ['prediction_label', 'GANship']
information_list = ['prediction_label']#['posterior_sorted', 'prediction_label', 'posterior_correct']
target_list = ['GANship']
