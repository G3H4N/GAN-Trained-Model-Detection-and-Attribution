...
for strctr in GAN_structures_list:
    ...
    saveData(strctr_dataset_save_dir, 'Testset_GANStrctr_real_multiclass', Testset_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Testset = loadData(os.path.join(data_path_strctr, 'Testset_GANStrctr_real_multiclass'))
...
saveData(save_addr, 'Testset_GANStrctr_real_AllStrctr_multiclass', Testset_AllStrctr)
