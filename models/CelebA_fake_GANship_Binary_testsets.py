...
for strctr in Strctr_classes_to_index_tensor:
    ...
    saveData(strctr_dataset_save_dir, 'fake_GANship_binary_Testset', Testset_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    Testset = loadData(os.path.join(data_path_strctr, 'fake_GANship_binary_Testset'))
    Testsets_strctr_list.append(Testset)

Testset_AllStrctr = torch.utils.data.ConcatDataset(Testsets_strctr_list)
saveData(save_addr, 'fake_GANship_binary_Testset_AllStrctr', Testset_AllStrctr)
