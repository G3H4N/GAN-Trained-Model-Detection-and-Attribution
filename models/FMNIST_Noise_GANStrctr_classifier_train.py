...
parser.add_argument('--save_name', dest='save_name', type=str, help='save name',
                    default='Noise_GANStrctr_withReal')
...
trainset_path = os.path.join(model_addr, 'noise_GANStrctr_Trainset_AllStrctr')
trainset = loadData(trainset_path)
train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True)
testset_path = os.path.join(model_addr, 'noise_GANStrctr_Testset_AllStrctr')
testset = loadData(testset_path)
test_loader = torch.utils.data.DataLoader(testset, batch_size=args.batch_size, shuffle=True)
testsetTGAN_path = os.path.join(model_addr, 'noise_GANStrctr_TestsetTGAN_AllStrctr')
...
CelebA_testsetTGAN_path = '/data/gehan/PytorchProjects/GANInference/models/outputs/noise_GANStrctr_TestsetTGAN_AllStrctr'
CelebA_testsetTGAN = loadData(CelebA_testsetTGAN_path)
CelebA_testTGAN_loader = torch.utils.data.DataLoader(CelebA_testsetTGAN, batch_size=args.batch_size, shuffle=True)

SVHN_testsetTGAN_path = '/data/gehan/PytorchProjects/GANInference/models/SVHN_outputs/noise_GANStrctr_TestsetTGAN_AllStrctr'
SVHN_testsetTGAN = loadData(SVHN_testsetTGAN_path)
SVHN_testTGAN_loader = torch.utils.data.DataLoader(SVHN_testsetTGAN, batch_size=args.batch_size, shuffle=True)
...
net = structures.lenet.attacker_noise(nch_info=1600, nch_output=5).to(device)
...
for ep in range(start_epoch, epochs):
    ...
    CelebA_accTGAN = test(net, CelebA_testTGAN_loader)
    SVHN_accTGAN = test(net, SVHN_testTGAN_loader)
