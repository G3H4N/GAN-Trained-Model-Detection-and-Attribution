...
parser.add_argument('--save_addr', dest='save_addr', type=str, help='save address',
                    default='/data/gehan/PytorchProjects/GANInference/models/attackers/')
parser.add_argument('--save_name', dest='save_name', type=str, help='save name',
                    default='Combine_SVHN_real_GANStrctr_CelebA_only')
...
trainset_path1 = os.path.join('/data/gehan/PytorchProjects/GANInference/models/outputs/SVHN_real_GANStrctr_Trainset_AllStrctr')
trainset1 = loadData(trainset_path1)
#trainset_path2 = os.path.join('/data/gehan/PytorchProjects/GANInference/models/FM_outputs/SVHN_real_GANStrctr_Trainset_AllStrctr')
#trainset2 = loadData(trainset_path2)
trainset = trainset1#torch.utils.data.ConcatDataset([trainset1, trainset2])
train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True)

testset_path1 = os.path.join('/data/gehan/PytorchProjects/GANInference/models/outputs/SVHN_real_GANStrctr_Testset_AllStrctr')
testset1 = loadData(testset_path1)
test_loader1 = torch.utils.data.DataLoader(testset1, batch_size=args.batch_size, shuffle=True)

testset_path2 = os.path.join('/data/gehan/PytorchProjects/GANInference/models/FM_outputs/SVHN_real_GANStrctr_Testset_AllStrctr')
testset2 = loadData(testset_path2)
test_loader2 = torch.utils.data.DataLoader(testset2, batch_size=args.batch_size, shuffle=True)

testsetTGAN_path1 = os.path.join('/data/gehan/PytorchProjects/GANInference/models/outputs/SVHN_real_GANStrctr_TestsetTGAN_AllStrctr')
testsetTGAN1 = loadData(testsetTGAN_path1)
#testsetTGAN_path2 = os.path.join('/data/gehan/PytorchProjects/GANInference/models/FM_outputs/SVHN_real_GANStrctr_TestsetTGAN_AllStrctr')
#testsetTGAN2 = loadData(testsetTGAN_path2)
testsetTGAN = testsetTGAN1#torch.utils.data.ConcatDataset([testsetTGAN1, testsetTGAN2])
testTGAN_loader = torch.utils.data.DataLoader(testsetTGAN, batch_size=args.batch_size, shuffle=True)

Third_testsetTGAN_path = os.path.join('/data/gehan/PytorchProjects/GANInference/models/SVHN_outputs/SVHN_real_GANStrctr_Trainset_AllStrctr')
Third_testsetTGAN = loadData(Third_testsetTGAN_path)
Third_testTGAN_loader = torch.utils.data.DataLoader(Third_testsetTGAN, batch_size=args.batch_size, shuffle=True)
...
net = structures.lenet.attacker_noise(nch_info=800, nch_output=4).to(device)
...
for ep in range(start_epoch, epochs):
    ...
    acc1 = test(net, test_loader1)
    acc2 = test(net, test_loader2)
    accTGAN = test(net, testTGAN_loader)
    Third_accTGAN = test(net, Third_testTGAN_loader)
