...
for strctr in Strctr_classes_to_index_tensor:
    ...
    TrainSet_strctr = torch.utils.data.TensorDataset(posterior_sorted, GAN_name)
    saveData(strctr_dataset_save_dir, 'TinyImageNet_GANship_TrainSet', TrainSet_strctr)
...
for data_path_strctr in dataset_strctr_path_list:
    TrainSet = loadData(os.path.join(data_path_strctr, 'TinyImageNet_GANship_TrainSet'))
...
saveData(save_addr, 'TinyImageNet_GANship_TrainSet_AllStrctr', TrainSet_AllStrctr)
